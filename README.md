...
This project leverages GROQ API to answer user queries. Additionally, the application supports dynamic switching between bots, allowing users to explore model capabilities or engage in an ongoing conversation seamlessly. It is pretty simple to use.
